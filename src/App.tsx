...
function App() {
  ...
  useEffect(() => {
    ...
    if (window.ipcRenderer) {
      ...
      window.ipcRenderer.on('overall-connection-status', (_event, data) => {
        ...
        // If we just connected or switched mode, add a professional log
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    // 🧲 MAGNET SCAN: Support both old 'files' and modern 'items' API
  ...
  return (
    <div
      className={`app-container ${isDragging ? 'global-dragging' : ''}`}
          ...
          <div className="card">
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              <input
                ...
                onMouseUp={() => {
                  // Auto-reset selection after a brief moment to prevent sync-engine "stickiness"
                  setTimeout(() => {
